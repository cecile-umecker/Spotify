...
class SearchArtists extends Component {
    ...
    getApi(pageNumber) {
        ...
        fetch(`/api/search/artists/${search}?page=${pageNumber}`)
            .then((response) => {
    ...
    render() {
        return (
            <div className="container">
                ...
                <h1 className="text-center mb-5">Liste des artistes contenant le(s) terme(s) {this.props.match.params.name}</h1>
